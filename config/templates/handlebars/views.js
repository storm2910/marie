...
module.exports.views = {
  ...
  *                                                                           *
  * handlebars, handlebars, handlebars, mustache underscore, hogan, haml, haml-coffee,     *
  * dust atpl, eco, ect, jazz, jqtpl, JUST, liquor, Qhandlebars, swig, templayed,    *
  ...
  * your server-side views. If you're using handlebars or handlebars, you can take         *
  ...
  *                                                                           *
  * NOTE: Layout support is only implemented for the `handlebars` view engine!       *
  ...
  * file from `views/` folder. (the file extension, ".handlebars", should be         *
  * omitted)                                                                  *
  *                                                                           *
  ****************************************************************************/
  ...
  *                                                                           *
  * If you're using the default `handlebars` or `handlebars` Sails supports the use  *
